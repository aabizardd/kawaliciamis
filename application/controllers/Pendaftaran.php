...
class Pendaftaran extends CI_Controller
{
    ...
    function detail(){
        ...
        $sql_labor    = "SELECT tp.*,tr.tanggal,tr.id_riwayat, ts.nama_pemeriksaan,ts.satuan,ts.nilai_rujukan,td.hasil,
                        td.keterangan FROM tbl_pemeriksaan_laboratorium as tp, tbl_riwayat_pemeriksaan_laboratorium as  tr,
                        tbl_sub_pemeriksaan_laboratoirum  as ts, tbl_riwayat_pemeriksaan_laboratorium_detail as td
                        WHERE tr.kode_periksa=tp.kode_periksa and tr.no_rawat='$no_rawat' and td.kode_sub_periksa=ts.kode_sub_periksa";
         ...
         foreach ($pemeriksaan as $p){
            ...
            $sub_periksa_sql = "SELECT ts.nama_pemeriksaan,ts.satuan,ts.nilai_rujukan,td.hasil,td.keterangan 
                                ...
                                WHERE td.kode_sub_periksa=ts.kode_sub_periksa 
                                 and td.id_riwayat=$p->id_riwayat";
