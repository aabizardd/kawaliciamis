                        ...
                        <div class='row'>
                            <div class='col-md-9'>
                                <div style="padding-bottom: 10px;">
                                    ...
                                    <?php echo anchor(site_url('penjualan/cetak'), '<i class="fa fa-wpforms" aria-hidden="true"></i> Cetak Laporan', 'class="btn btn-danger btn-sm"'); ?>
                                </div>
                            </div>
                            <div class='col-md-3'>
                                <form action="<?php echo site_url('penjualan/index'); ?>" class="form-inline"
                                    method="get">
...
//echo anchor(site_url('penjualan/read/'.$penjualan->no_faktur),'<i class="fa fa-eye" aria-hidden="true"></i>','class="btn btn-danger btn-sm"');
    //echo '  ';
    echo anchor(site_url('penjualan/update/' . $penjualan->no_faktur), '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', 'class="btn btn-info btn-sm"');
    echo '  ';
    echo '<button type="submit" class="btn btn-danger btn-sm remove-faktur"><i class="fa fa-trash-o" aria-hidden="true"></i> </button>';
    ?>
                                </td>
                            </tr>
                            <?php
