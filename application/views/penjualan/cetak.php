            ...
            <section class="content">
                <div class="box box-warning box-solid">
                    <div class="box-header with-border">
                        <center>
                            <h3 class="box-title">APOTEK PUSKESMAS KAWALI <br>
                                <?PHP echo "<img src='logo.png'/>"; ?>
                                <center>
                                    <h3 class="box-title">LAPORAN PENGELUARAN OBAT <br>
...
?>
                    ...
                    <table class="border" width="100%" border="1">
                        ...
                        <tr>
                            <td>Obat yang Paling Banyak Keluar</td>
                        ...
                        <tr>
                            <td>Obat yang Paling Sedikit Keluar</td>
