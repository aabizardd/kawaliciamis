            ...
            <form action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered>'>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="kode_dokter" id="kode_dokter"
                                placeholder="Kode Dokter" value="<?php echo $kode_dokter; ?>" /></td>
                    </tr>
                    <tr>
...
echo form_dropdown('hari', $hariArray, $hari, array('class' => 'form-control'))?>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="jam_mulai" id="jam_mulai"
                                placeholder="Jam Mulai" value="<?php echo $jam_mulai; ?>" /></td>
                    </tr>
                    <tr>
                        <td width='200'>Jam Selesai <?php echo form_error('jam_selesai') ?></td>
                        <td><input type="text" class="form-control" name="jam_selesai" id="jam_selesai"
                                placeholder="Jam Selesai" value="<?php echo $jam_selesai; ?>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="id_jadwal" value="<?php echo $id_jadwal; ?>" />
                            ...
                            <a href="<?php echo site_url('jadwalpraktek') ?>" class="btn btn-info"><i
