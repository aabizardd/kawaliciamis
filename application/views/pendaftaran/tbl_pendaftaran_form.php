            ...
            <div class="col-md-6">
                <div class="box box-warning box-solid">
                    ...
                    <table class='table table-bordered>'>
                        ...
                        <tr>
                            <td width='200'>No Rawat <?php echo form_error('no_rawat') ?></td><td><input type="text" class="form-control" name="no_rawat" placeholder="No Rawat" readonly="" value="<?php echo date('Y/m/d/') . noRegOtomatis(); ?>" /></td>
                        </tr>
                        ...
                        <tr>
                            <td width='200'>Asal Rujukan <?php echo form_error('asal_rujukan') ?></td><td><input type="text" class="form-control" name="asal_rujukan" id="asal_rujukan" placeholder="Asal Rujukan" value="<?php echo $asal_rujukan; ?>" /></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
            ...
            <div class="col-md-6">
                <div class="box box-warning box-solid">
                    ...
                    <table class='table table-bordered>'>
                        ...
                        <tr>
                            <td>Nama pasien</td>
                            <td><input type="text" name="nama" id="nama_pasien" class="form-control" placeholder="nama pasien"></td></tr>
                        <tr>
                            <td>Tanggal Lahir</td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="nama_penanggung_jawab" id="nama_penanggung_jawab" placeholder="Nama Penanggung Jawab" value="<?php echo $nama_penanggung_jawab; ?>" /></td></tr>
                        <tr>
