    ...
    <section class="content">
        <div class="box box-warning box-solid">
            ...
            <table class='table table-bordered>'        
                ...
                <tr><td width='200'>Penyedia <?php echo form_error('kode_supplier') ?></td>
                    <td><?php echo $nama_supplier; ?></td></tr>
                
                <tr><td></td><td>
                        <a target="_blank" href="<?php echo site_url('pengadaan/cetak/'.$no_faktur) ?>" type="button" class="btn btn-danger">Cetak Laporan</a>
